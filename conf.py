...
CONTENT_FOOTER = u'Contenido &copy; 2012 Cátedra AdC - FaMAF - UNC'
...
GLOBAL_CONTEXT = {
    ...
    'sidebar_links': {
        DEFAULT_LANG: (
            ('/stories/teoricos.html', u'Teóricos'),
            ('/stories/practicos.html', u'Prácticos'),
            ('/stories/cronograma.html', u'Cronograma'),
            ('/' + os.path.join(ARCHIVE_PATH, ARCHIVE_FILENAME), 'Noticias anteriores'),
            ),
        }
    }
